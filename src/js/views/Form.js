        ...
        <main>
          ...
          <div class="row g-5">
            <div class="col-md-5 col-lg-4 order-md-last">
              ...
              <form id="formPromo" class="card p-2">
            ...
            <div class="col-md-7 col-lg-8">
              ...
              <form id="formMain" class="needs-validation" novalidate="">
                <div class="row g-3">
                  <div class="col-sm-6">
                ...
                <button class="w-100 btn btn-primary btn-lg" onclick="${onSubmit}">Continue to checkout</button>
